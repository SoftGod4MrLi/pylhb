...
class MyMSSQLDo:
    ...
    def help(self):
        ...
        print("11.架构对比（即对比更新）")
        print("  A.对比更新")
        print("  如：pylhb mssql compare -S localhost\\sqlexpress -U sa -P fpsoft@123 -D MyCustomer -TS localhost\\sqlexpress -TU sa -TP fpsoft@123 -TD Test")
        print("  A.对比到脚本文件")
        print("  如：pylhb mssql compare -S localhost\\sqlexpress -U sa -P fpsoft@123 -D MyCustomer -TS localhost\\sqlexpress -TU sa -TP fpsoft@123 -TD Test--comparetofile --file D:\\dd\\bkfile.bak")
        print("12.执行SQL文件")
        print("  A.file：SQL文件")
